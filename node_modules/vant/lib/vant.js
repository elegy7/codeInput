...
var sfc = __webpack_require__(5);

// EXTERNAL MODULE: ./es/locale/index.js + 1 modules
var locale = __webpack_require__(2);
...
// EXTERNAL MODULE: ./es/utils/use/sfc.js
var use_sfc = __webpack_require__(5);
...
/* harmony default export */ var create_basic = (function (sfc) {
  ...
  sfc.methods.b = Object(bem["a" /* default */])(sfc.name);
  return sfc;
});
...
var _use = Object(utils["h" /* use */])('actionsheet'),
    actionsheet_sfc = _use[0],
    actionsheet_bem = _use[1];
...
/* harmony default export */ var card = (card_sfc({
  ...
  render: function render(h) {
    ...
    var Price = (slots.price || Object(utils["d" /* isDef */])(this.price)) && h("div", {
      "class": card_bem('price')
    }, [slots.price || this.currency + " " + this.price]);
    var OriginPrice = Object(utils["d" /* isDef */])(this.originPrice) && h("div", {
      "class": card_bem('origin-price')
    }, [this.currency + " " + this.originPrice]);
    var Num = (slots.num || Object(utils["d" /* isDef */])(this.num)) && h("div", {
      "class": card_bem('num')
...
/* harmony default export */ var es_coupon = (coupon_sfc({
  ...
  render: function render(h) {
    ...
    }), "\n            ", h("p", [this.conditionMessage])]), "\n          ", h("div", {
      "class": coupon_bem('body')
    }, [h("h2", [coupon.name]), "\n            ", h("p", [this.validPeriod]), "\n            ", this.chosen && h(es_checkbox, {
      "attrs": {
        "value": true
      },
...
var version = '1.5.2-beta';
var components = [actionsheet, address_edit, address_list, es_area, badge, badge_group, es_button, card, es_cell, cell_group, es_checkbox, checkbox_group, circle, col, collapse, collapse_item, contact_card, contact_edit, contact_list, es_coupon, coupon_cell, coupon_list, datetime_picker, dialog, field, goods_action, goods_action_big_btn, goods_action_mini_btn, icon, image_preview, info, list, loading, locale["a" /* default */], nav_bar, notice_bar, notify, number_keyboard, overlay, pagination, panel, password_input, es_picker, es_popup, es_progress, pull_refresh, es_radio, radio_group, es_rate, row, search, sku, slider, step, stepper, steps, submit_bar, swipe, swipe_cell, swipe_item, es_switch, switch_cell, tab, tabbar, tabbar_item, tabs, tag, es_toast, tree_select, uploader];
